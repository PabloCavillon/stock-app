	...
	return (
		<div className="bg-white rounded-3xl border border-zinc-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6">
			<div className="flex items-center gap-3 mb-6">
				...
				<div>
					<h2 className="text-sm font-bold text-zinc-900 dark:text-white uppercase tracking-tight">Productos Top</h2>
			...
			{data.length === 0 ? (
				...
				<ResponsiveContainer width="100%" height={240}>
					<BarChart data={data} layout="vertical" margin={{ left: -20, right: 20 }} style={{ background: 'transparent' }}>
						...
						<XAxis type="number" tick={{ fontSize: 11, fill: xLabelColor, fontWeight: 600 }} axisLine={false} tickLine={false} />
